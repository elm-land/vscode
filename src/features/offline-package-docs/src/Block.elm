...
-- https://github.com/elm/package.elm-lang.org/blob/master/src/frontend/Page/Docs/Block.elm
...
view info block =
    case block of
        Docs.MarkdownBlock markdown ->
            Markdown.toHtml [ class "markdown" ] markdown
...
toLinkLine info qualifiedName =
    case Dict.get qualifiedName info.typeNameDict of
        ...
        Just ( moduleName, name ) ->
            One (String.length name) [ span [] [ text name ] ]
